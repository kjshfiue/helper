...
public class CompanyDaoImpl extends BaseDao implements CompanyDao {
	...
	public int insert(Company company) {
		// TODO Auto-generated method stub
			String sql="insert into basecompany(code,compname,compaddress) " +
					"values(?,?,?)";
			int ret= super.executeUpdate(sql,new Object[]{company.getCid(),company.getcName(),company.getcAddress()});
			return ret;
